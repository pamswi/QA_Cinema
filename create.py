...
with app.app_context():
    ...
    Movie(title="Lawrence of Arabia", director="David Lean", actors="Peter O'Toole, Alec Guinness", release_date="1962-12-10", description="An epic adventure in the Arabian desert.", poster="{{ url_for('static', filename='lawrenceofarabia.jpeg') }}", classic=True, age_restricted=False),
    Movie(title="The Wizard of Oz", director="Victor Fleming", actors="Judy Garland, Frank Morgan", release_date="1939-08-15", description="A beloved family fantasy film.", poster="{{ url_for('static', filename='wizardofoz.jpeg') }}", classic=True, age_restricted=False),
